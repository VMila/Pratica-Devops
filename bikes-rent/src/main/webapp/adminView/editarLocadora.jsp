...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title><fmt:message key="locadora.edit" /></title>
    </head>
            ...
            <div class="max-w-lg w-full p-8 bg-white rounded-lg shadow-lg">
                ...
                <form action="${pageContext.request.contextPath}/admin/atualizarLocadora" method="post" class="space-y-4">
                    ...
                    <div class="text-center">
                        <button type="submit"
                            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"><fmt:message key="atualizar" /></button>
                    </div>
                </form>
            </div>
        </div>
