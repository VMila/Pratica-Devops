...
<body class="bg-gray-100">
    ...
    <div class="flex justify-center items-center h-screen">
        <div class="max-w-md w-full p-8 bg-white rounded shadow-lg">
            <h2 class="text-2xl font-bold text-gray-800 mb-4 text-center"><fmt:message key="cliente.login" /></h2>
            <form action="${pageContext.request.contextPath}/clienteLogin" method="post">
                <div class="mb-4">
