...
<body class="bg-gray-100">
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-500 dark:border-gray-700">
                    ...
                    <li>
                        <a href="/bikes-rent/locadora/novo" class="block py-2 px-3 md:text-blue-700 hover:text-blue-300 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0
                         ...
                         <fmt:message key="locadora.register" />
                        </a>
                    </li>
                    <li>
    ...
    <div class="flex justify-center items-center h-screen">
        <div class="max-w-md w-full p-8 bg-white rounded shadow-lg">
            <h2 class="text-2xl font-bold text-gray-800 mb-4 text-center"><fmt:message key="locadora.login" /></h2>
            <form action="${pageContext.request.contextPath}/locadoraLogin" method="post">
                <div class="mb-4">
